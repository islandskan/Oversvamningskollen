    ...
    <SafeAreaView className={`flex-1 ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
      <View className="flex-1 justify-center items-center px-6">
        ...
        <View className="mb-10 items-center">
          <MaskedView maskElement={<Text className="text-5xl font-bold">FloodCast</Text>}>
            <LinearGradient
              colors={["#a855f7", "#ec4899"]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
            >
              <Text className="text-5xl font-bold opacity-0">FloodCast</Text>
            </LinearGradient>
          </MaskedView>
        ...
        <View className="w-full rounded-3xl p-6 shadow-lg overflow-hidden">
          ...
          <TextInput
            ...
            className={`${
              isDark ? "bg-gray-800/80 text-white" : "bg-white/90 text-gray-900"
