...
typedef enum {
    ...
    THRESHOLD_ABOVE_20 = 1u << 5, // 32
    THRESHOLD_ABOVE_30 = 1u << 6, // 64
    THRESHOLD_ABOVE_40 = 1u << 7, // 128
    THRESHOLD_ABOVE_50 = 1u << 8, // 256
    RATE_OF_CHANGE_SMALL = 1u << 9, // 512
    RATE_OF_CHANGE_MEDIUM = 1u << 10, // 1024
    RATE_OF_CHANGE_LARGE = 1u << 11, // 2048
    INTERNAL_FLAG_01 = 1u << 12, // 4096
    INTERNAL_FLAG_02 = 1u << 13, // 8192
    INTERNAL_FLAG_03 = 1u << 14, // 16384
    INTERNAL_FLAG_04 = 1u << 15, // 32768
} SensorFlags;
