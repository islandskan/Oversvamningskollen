...
import { FloodRiskArea, floodRiskAreas as mockData } from '@/Frontend/data/floodRiskData';
import { floodRiskService, LocationQuery } from '@/Frontend/services/floodRiskService';
